...
<%-- 		<h1
	...
	<div class="card text-center" style="width:1000px;margin:0 auto;">
		<form method="post" enctype="multipart/form-data" id="editphoto">
		...
		<div class="card-body">
			...
			<div id="editImg" style="width:100px;margin-top: 15px;margin-left:370px;">
			</div>
			<span style="color: black; font-weight: bold;vertical-align:10px;">이메일 :
