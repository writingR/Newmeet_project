...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/animate.css">
    
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/owl.carousel.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/magnific-popup.css">

    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/aos.css">

    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/ionicons.min.css">
    
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/flaticon.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/icomoon.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/calendar/detail/css/style.css">
		    			...
		    			<div class="col-md-12 col-lg-12 ftco-animate">
		    				<div class="project">
		    					<div class="img">
				    				...
				    				<a href="${pageContext.request.contextPath}/static/calendar/detail/destination-single.html"><img src="${pageContext.request.contextPath}/static/detail/images/destination-1.jpg" class="img-fluid" alt="Colorlib Template"></a>
			    				</div>
			    				<div class="text">
			    					<h4 class="price"><span class="old-price mr-2">$500</span>$400</h4>
			    					<span>15 Days Tour</span>
			    					<h3><a href="${pageContext.request.contextPath}/static/calendardetail/destination-single.html">Gurtnellen, Swetzerland</a></h3>
			    				...
			    				<a href="${pageContext.request.contextPath}/static/calendardetail/images/destination-1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
