  				...
  				success : function(data) {
  					...
  					if(data == 2){
						...
						html2 += '<input type="button" onclick="moimdelete()" style="background-color: rgba(255,255,255,0.3); border:1px solid black; cursor: pointer;" value="삭제">';
  						...
  						//alert('넌 모임원');
  						html += '<input type="button" class="form-control btn btn-primary" value="모임 탈퇴">';
  						
  						$('#button').html(html);
  					}else if(data == 0){
  						//alert('넌 비모임원');
  						html += '<input type="button" class="form-control btn btn-primary" value="모임 신청">';
  						
  						$('#button').html(html);
  					}else if(data == -1){
  						//alert('넌 로그인도안함');
  						
  						html += '<input type="button" class="form-control btn btn-primary" value="로그인해라">';
