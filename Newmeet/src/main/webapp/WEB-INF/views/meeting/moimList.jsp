...
<a class="btn btn-primary" href="<c:url value="/likestar?likestar=1"/>">좋아요순</a>
<a class="btn btn-primary" href="<c:url value="/likestar?likestar=2"/>">별점 순</a>
<a class="btn btn-primary" href="<c:url value="/moimList" />">전체 리스트</a>
</div>
		...
		$.ajax({
			...
			success : function(data) {
				...
				for (var i = 0; i < data.length ; i++) {
					...
					html += '<p><a href="<c:url value="/moimInfo"/>?m_idx='+ data[i].m_idx +'" class="btn btn-primary">모임보러가기</a></p>';
					html += '</div>';
					html += '</div>';
