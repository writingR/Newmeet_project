			...
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade"
					...
					<a class="block-2-item" href="#">
						<figure class="image">
							<img src="bootstrap/images/women.jpg" alt="" class="img-fluid">
						</figure>
						<div class="text">
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade"
					...
					<a class="block-2-item" href="#">
						<figure class="image">
							<img src="bootstrap/images/children.jpg" alt="" class="img-fluid">
						</figure>
						<div class="text">
							<span class="text-uppercase">Collections</span>
							<h3>Children</h3>
				...
				<div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade"
					...
					<a class="block-2-item" href="#">
						<figure class="image">
							<img src="bootstrap/images/men.jpg" alt="" class="img-fluid">
						</figure>
						<div class="text">
							<span class="text-uppercase">Collections</span>
							<h3>Men</h3>
				...
				<div class="col-md-12">
					<div class="nonloop-block-3 owl-carousel">
						<div class="item">
							<div class="block-4 text-center">
								<figure class="block-4-image">
									<img src="bootstrap/images/cloth_1.jpg" alt="Image placeholder"
										class="img-fluid">
								</figure>
						...
						<div class="item">
							<div class="block-4 text-center">
								<figure class="block-4-image">
									<img src="bootstrap/images/shoe_1.jpg" alt="Image placeholder"
										class="img-fluid">
								</figure>
								<div class="block-4-text p-4">
									<h3>
						...
						<div class="item">
							<div class="block-4 text-center">
								<figure class="block-4-image">
									<img src="bootstrap/images/cloth_2.jpg" alt="Image placeholder"
										class="img-fluid">
								</figure>
								<div class="block-4-text p-4">
									<h3>
						...
						<div class="item">
							<div class="block-4 text-center">
								<figure class="block-4-image">
									<img src="bootstrap/images/cloth_3.jpg" alt="Image placeholder"
										class="img-fluid">
								</figure>
								<div class="block-4-text p-4">
									<h3>
		...
		<div class="container">
			...
			<div class="row align-items-center">
				<div class="col-md-12 col-lg-7 mb-5">
					<a href="#"><img src="bootstrap/images/blog_1.jpg"
