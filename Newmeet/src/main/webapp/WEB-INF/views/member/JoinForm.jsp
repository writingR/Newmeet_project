...
<h5 style="color: black; text-align: center; padding: 100px; font-weight: bold;">이메일로 회원가입</h5>
	<form id="regForm" enctype="multipart/form-data" name="joinData">
		<div style="width: 400px; margin: 0 auto; margin-top: -60px;">
				<!-- <img alt="" src="images/default.png" style="width:120px;height:120px;"> -->
			<!-- <span style="color:black;font-weight: bold;">프로필사진</span> -->	
			
			
			<div style="width:210px;margin: 0 auto;">
				<label for="formGroupExampleInput"></label>
				<img alt="" src="static/img/noimage.png" style="width: 200px;height:200px;">
				<span class="btn btn-default btn-file" style="border:1px solid gray;margin-left:-20px;margin-top:10px;">
					<input type="file" name="nphoto" id="nphoto" style="border-radius:3px;width:220px;margin:10px;" placeholder="파일">
				</span>
			</div><br>
			<div class="form-group">
				<label for="formGroupExampleInput"><span style="color:black;font-weight: bold;">아이디</span></label> 
					...
					placeholder="6~10 아이디를 입력해주세요." style="width: 400px;"> <span id="idcheckmsg"></span>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="formGroupExampleInput2"><span style="color:black;font-weight: bold;">닉네임</span></label> 
					...
					placeholder="원하시는 별명을 입력해주세요." style="width: 400px;"><span id="niccheckmsg"></span>
			</div>
			<br>
<!-- 			<div class="form-group form-check">
			...
			<input type="submit" value="가입요청"  class="clickbtn" id="joinOK"
