...
public class CalendarInfo {
	...
	public CalendarInfo(int c_idx, int m_idx, String c_title, int c_pay, int c_count, String c_place, String c_address,
	...
	public String toString() {
		return "CalendarInfo [c_idx=" + c_idx + ", m_idx=" + m_idx + ", c_title=" + c_title + ", c_pay=" + c_pay
				+ ", c_count=" + c_count + ", c_place=" + c_place + ", c_address=" + c_address + ", c_date=" + c_date
				+ ", c_edate=" + c_edate + "]";
	}
